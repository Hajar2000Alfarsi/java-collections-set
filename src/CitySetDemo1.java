...
public class CitySetDemo1 {
    public static void main(String[] args){
        ...
        cityNames.add("Ibri");
        System.out.println("City Names(After Add city Ibri): ");
        for (String names:cityNames){
            System.out.println(names);
        }
        cityNames.add("Muscat");
        ...
        boolean exists1=cityNames.contains("Barka");
        System.out.println("Does Barka exist? " + exists1);
        ...
        cityNames.add("Bahla");
        System.out.println("City Names(After Add city Bahla): ");
        for (String names:cityNames) {
            System.out.println(names);
        }
        System.out.println("Total number of Cites: " + cityNames.size());
